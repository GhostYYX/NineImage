...
import com.yyx.nineimage.photopicker.PhotoPickerActivity;
...
public class PhotoPickersActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_picker_s);
